...
```{r}
df_250_homo_lin <- generate_data(n = 250, effect_type = "homogeneous", response_surface = "linear")
df_250_hete_lin <- generate_data(n = 250, effect_type = "heterogeneous", response_surface = "linear")
